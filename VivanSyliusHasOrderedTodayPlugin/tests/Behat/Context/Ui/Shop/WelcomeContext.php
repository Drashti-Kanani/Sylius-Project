...
namespace Tests\Vivan\SyliusHasOrderedTodayPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\Vivan\SyliusHasOrderedTodayPlugin\Behat\Page\Shop\WelcomePageInterface;
